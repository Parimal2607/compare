  ...
  return (
    <div>
      <h3 className="mb-4 flex items-center gap-2 text-base font-semibold text-gray-900">
        {label}
        {winner && (
          <span className="inline-flex items-center gap-0.5 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 px-2 py-0.5 text-[10px] font-bold text-white shadow-sm">
            WINNER
          </span>
        )}
      </h3>
